...
export const voices = {
  ...
  gallery: {
    ...
    eyebrow: P('Portrait studio · Plainfield, Illinois', ''),
    ...
    ctaPrimary: P('View Portfolio', ''),
    ctaSecondary: P('Book a Session', ''),
    sectionTitles: {
  ...
  booking: {
    ...
    eyebrow: P('Now booking · Plainfield, Illinois', ''),
    ...
    ctaPrimary: P('Check Availability', ''),
    ctaSecondary: P('See the Work', ''),
    sectionTitles: {
  ...
  story: {
    ...
    ctaPrimary: P('Write to Me', ''),
    ctaSecondary: P('View Portfolio', ''),
    sectionTitles: {
